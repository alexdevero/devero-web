...
const Nexus = memo(() => {
  ...
  return (
    <Layout title="Master Plan | Devero">
      <PageHeader
        title={intl.formatMessage({ defaultMessage: 'Master plan' })}
      />
      ...
      <div className="row justify-content-center">
        <div className="col-md-10 col-lg-8">
          ...
          <ul className="list-unstyled">
            ...
            <li>
              &ndash;More like Virgin corporation: product itself will be
              corporation umbrella a group of subsidiaries
            </li>
            <li>&ndash;One starting point is startup/product garage/lab</li>
            <li>
              &ndash;Second starting point is startup accelerator and incubator
            </li>
            <li>
              &ndash;I love building startups and products, I am good at it,
              that's the start
            </li>
          </ul>
          ...
          <ul className="list-unstyled">
            ...
            <li>
              &ndash;Building software, hardware and just &ldquo;hacking&rdquo;
              (Hacker lab)
            </li>
          </ul>
          ...
          <div className="list-unstyled">
            <li>
              &ndash;startup builder: application for companies and governments
              for planning and building startups
            </li>
            <li>
              &ndash;product builder: application for companies, startups and
              individuals for planning and building startups
            </li>
          </div>
          ...
          <ul className="list-unstyled">
            <li>
              &ndash;Investment management corporation (Bridgewater Associates,
              BlackRock)
            </li>
          </ul>
        </div>
